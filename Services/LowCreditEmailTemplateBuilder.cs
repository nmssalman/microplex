...
public static class LowCreditEmailTemplateBuilder
{
    ...
    <title>Low SMS Credit Alert</title>
    <style>
      @keyframes pulse-warn { 0%,100% { transform: scale(1); } 50% { transform: scale(1.08); } }
      @keyframes pulse-ring {
        0% { box-shadow: 0 0 0 0 rgba(255,107,97,.45); }
        70% { box-shadow: 0 0 0 14px rgba(255,107,97,0); }
        100% { box-shadow: 0 0 0 0 rgba(255,107,97,0); }
      }
        ...
        <tr><td align="center">
          <table role="presentation" width="480" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:16px;overflow:hidden;box-shadow:0 20px 50px rgba(13,39,80,.12);max-width:92%;">
            ...
            <tr><td style="padding:40px 32px 8px;text-align:center;">
              <div class="alert-icon" style="width:64px;height:64px;border-radius:50%;background:#fdecec;color:#ff6b61;font-size:30px;line-height:64px;margin:0 auto 20px;">&#9888;</div>
              <h1 style="margin:0 0 8px;font-size:22px;color:#15213a;">Low SMS Credit Alert</h1>
            </td></tr>
            <tr><td style="padding:0 32px;text-align:center;">
              <div style="display:inline-block;padding:14px 28px;border-radius:14px;background:#f5f8fc;margin:8px 0 24px;">
                ...
                <div style="font-size:34px;font-weight:900;color:#ff6b61;margin-top:4px;">{{Balance}} units</div>
              </div>
            </td></tr>
            <tr><td style="padding:0 32px 32px;color:#15213a;font-size:15px;line-height:1.8;">
              <p style="margin:0 0 16px;">Dear {{CompanyName}},</p>
              <p style="margin:0 0 16px;">Our servers indicates that you SMS Credit balance is under 200 and getting to low. please recharge your SMS credit to enjoy uninterrupted service.</p>
