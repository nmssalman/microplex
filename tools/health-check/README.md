...
gateway APIs. Runs via `.github/workflows/daily-health-check.yml` at ~5:03 PM
UTC (~10:33 PM Asia/Colombo) every day, and emails a color-coded HTML report to the address
